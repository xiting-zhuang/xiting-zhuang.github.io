...
M.S. in Computer Science   \hfill 2026
	...
	\begin{itemize}
		...
		\textit{International Journal of Educational Development}. (\textit{Accepted}). 
		...
		\textit{Applied Economics}. (\textit{Accepted}). 
		
		\item[-] Colin A. Carter, Sandro Steinbach\corrauthor, \& \textbf{Xiting Zhuang} (2025).  
		...
		\item[-] Sandro Steinbach\corrauthor\& \textbf{Xiting Zhuang} (2025).  
		``Trade Implications of Ending China’s Zero-Covid Policy.''  
		\textit{Asian Economics Letters}. (Accepted)
		
		\item[-] Sandro Steinbach\corrauthor \& \textbf{Xiting Zhuang} (2023).  
		...
		\item[-] Colin A. Carter, Sandro Steinbach\corrauthor, \& \textbf{Xiting Zhuang} (2022).  
		...
		\item[-] Henning Schweizer, Sandro Steinbach\corrauthor, \& \textbf{Xiting Zhuang} (2022).  
		``A Portrait of Firms that Trade in Meat Products.''  
		\textit{Western Economics Forum}.
		
		\item[-] Rachit Goyal, Sandro Steinbach\corrauthor, Yavuz Yildirim, \& \textbf{Xiting Zhuang} (2024).  
	...
	\begin{itemize}
		\item[-]  Zhihong Xu\corrauthor; Jaehyun Ahn; Shuai Ma; Anjorin Ezekiel Adyemi; Fahmida Husain Choudhury;  \textbf{Xiting Zhuang}; Rafael Landaverde; Gary J. Wingenbach. ``Bridging Language and Data: Transforming Agricultural Curricula for Data Analytics Through Linguistic Insights'' 
		
		
\item[-] Peng Lu\corrauthor, Lulu Mao,  \& \textbf{Xiting Zhuang}, Zhihong Xu \& Shuai Ma.  
